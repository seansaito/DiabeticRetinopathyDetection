...
rf = RandomForestClassifier(n_estimators=100, n_jobs=100)
rf.fit(imageMultiArr.T, list(df['level'][trainingImageIndex[1:numTraining]]))
...
#for i in range(1,200):
	...
	predictedVal = rf.predict(testImageArrPrep.T)
	print predictedVal
